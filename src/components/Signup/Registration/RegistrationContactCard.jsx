...
function RegistrationContactCard() {

let contactList = ['FAQHelp', 'Centre', 'Netflix Shop','Terms of Use','Privacy','Cookie Preferences','Corporate Information',]



  return (
    <>
       <div className='regContactCard flex item-start flex-col px-32 py-16 text-zinc-400 ' >
            <h1 className='font-medium text-lg mb-5'>Questions? Call <span>000-800-919-1694</span></h1>
            <div className='flex flex-wrap '>
                {contactList.map(item=><h1 className='cursor-pointer  w-[17rem] mb-4 text-sm font-normal'>{item}</h1>)}
            </div>
...
export default RegistrationContactCard
...
function Navbar() {
  return (
    <>
        <div className='px-36 flex fixed m-1 items-center w-screen justify-between bg-transparent absolute z-10'>
            <img src={logo} className='h-20' alt='netflix-logo' />
            <div className='flex'>
                ...
                <button className='getStartedButtonStyle ml-7 w-20 text-sm font-semibold '>Sign In</button>
            </div>
        </div>
